...
sap.ui.define([
		...
		return BaseController.extend("com.pepsico.reference.masterDetail.pepsico_mater_detail_reference_app.controller.Detail", {
			...
			_onObjectMatched : function (oEvent) {
				...
				this.getModel().metadataLoaded().then( function() {
					var sObjectPath = this.getModel().createKey("Transportations", {
						TransportationNum :  sObjectId
					});
