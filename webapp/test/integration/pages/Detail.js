		...
		onTheDetailPage : {
			...
			assertions : {
				...
				theLineItemsListShouldHaveTheCorrectNumberOfItems : function () {
					return this.waitFor(this.createAWaitForAnEntitySet({
						entitySet : "TransportationItemDetails",
						success : function (aEntitySet) {
							...
							return this.waitFor({
								...
								check: function (oList) {
									...
									var sObjectID = oList.getBindingContext().getProperty("TransportationNum");

									var iLength = aEntitySet.filter(function (oLineItem) {
										return oLineItem.TransportationNum === sObjectID;
									}).length;
					...
					return this.waitFor({
						...
						success : function (oList) {
							...
							return this.waitFor({
								id : "lineItemsTitle",
								viewName : sViewName,
								matchers : new PropertyStrictEquals({name: "text", value: "<TransportationItemDetailsPlural> (" + iNumberOfItems + ")"}),
								success : function () {
